...
AS $$
DECLARE
  project_url TEXT := 'https://fgxgwcagpbnlwbsmpdvh.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZneGd3Y2FncGJubHdic21wZHZoIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDM4NjM5NjAsImV4cCI6MjA1OTQzOTk2MH0.YJ2HFiy12i81UeF_hhKhOKwsh0tRXwjHwca343_HYKg'; -- full access needed for http request to storage
